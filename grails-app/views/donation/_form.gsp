...
<div class="col-lg-6">
	<div class="disabled input-group fieldcontain ${hasErrors(bean: donationInstance, field: 'description', 'error')} required">
		...
		<g:textField disabled="" class="form-control" name="description" maxlength="100" required="" value="${donationInstance?.description}"/>

	</div>
</div>
</g:if>

<g:if hidden="" test="${'[ROLE_NONE]' in session.SPRING_SECURITY_CONTEXT.authentication.principal.authorities.toString()}">
<div class="col-lg-6">
	<div class="disabled input-group fieldcontain ${hasErrors(bean: donationInstance, field: 'description', 'error')} required">
		<span class="input-group-addon">
			<g:message code="donation.description.label" default="Description" />
...
<div class="col-lg-6">
	<div class="disabled input-group fieldcontain ${hasErrors(bean: donationInstance, field: 'type', 'error')} required">
		...
		<g:select disabled="" class="form-control" name="type" from="${donationInstance.constraints.type.inList}" required="" value="${donationInstance?.type}" valueMessagePrefix="donation.type"/>
...
<div class="col-lg-6">
	<div class="disabled input-group fieldcontain ${hasErrors(bean: donationInstance, field: 'value', 'error')} required">
		...
		<g:field disabled="" class="form-control" name="value" value="${fieldValue(bean: donationInstance, field: 'value')}" required=""/>
...
<div class="col-lg-6">
	<div class="disabled input-group fieldcontain ${hasErrors(bean: donationInstance, field: 'donator', 'error')} required">
		...
		<div class="disabled">
			<g:select disabled="" class="form-control" id="donator" name="donator.id" from="${network.klwcin.security.User.list()}" optionKey="id" required="" value="${donationInstance?.donator?.id}" class="many-to-one"/>
		</div>
	</div>
</div>
</g:if>
