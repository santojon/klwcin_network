...
invokeTag('eachError','g',24,['bean':(donationInstance),'var':("error")],3)
printHtmlPart(16)
})
invokeTag('hasErrors','g',26,['bean':(donationInstance)],2)
printHtmlPart(9)
createTagBody(2, {->
printHtmlPart(17)
...
invokeTag('form','g',34,['url':([resource:donationInstance, action:'save'])],2)
printHtmlPart(20)
})
...
public static final long LAST_MODIFIED = 1409703071346L
